package com.gustavo.escala.resources.exception;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> objetonotFoundException(ObjectNotFoundExcpetion ex, HttpServletRequest request){
